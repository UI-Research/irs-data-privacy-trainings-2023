...
* `synth1` looks to match the variance of the confidential data but the mean is a little to high. `synth2` matches the mean, but it contains far too little variance. There aren't enough observations in the tails of the synthetic data.
