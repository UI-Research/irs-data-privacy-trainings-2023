...
-   Modern computing and technology has made collecting and processing large amounts of data quickly.
...
-   At the same time, releasing granular data can be of immense value to researchers. For example, cell phone data are invaluable for emergency responses to natural disasters, and granular medical data will lead to better treatment and development of cures. ![](images/racial_data_covid.png){width="310"}
...
-   Below is an opinionated, and incomplete overview of various SDC methods. For this set of traing sessions, we will focus in-depth on the methods in yellow.
...
-   A newer development in the SDC field with the potential to overcome some of these problems is Synthetic Data, which we will discuss further in session 2.
